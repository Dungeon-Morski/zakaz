        ...
        if (m.readyState === m.DONE && 200 === m.status) {
            ...
            if ("y" === p.filter && !r.hideFilters && t) t && (t.filters && t.filters.length > 0 || t.search || t.sort) && t_store_onFuncLoad("t_store_filters_init", (function() {
                ...
                if (h) {
                    ...
                    var w = "RU" === window.tStoreBrowserLang ? 'Пожалуйста, добавьте хотя бы один фильтр каталога для отображения боковой панели магазина. <a href="https://help-ru.tilda.cc/online-store-payments/filters" target="_blank" rel="nofollow noopener">Справка</a>' : 'Please <a href="https://help.tilda.cc/online-store-payments/filters" target="_blank" rel="nofollow noopener">add at least one catalog filter</a> to display the store sidebar';
...
function t_store_product_sortValues(t, e, r) {
    ...
    var i = "filter" === e ? t[0].value.toString() : t[0].toString(),
        ...
        a = ["XXXS", "3XS", "XXS", "2XS", "XS", "S", "M", "L", "XL", "XXL", "2XL", "XXXL", "3XL", "XXXXL", "BXL", "4XL", "BXXL", "5XL", "BXXXL", "6XL", "ONE SIZE", "ОДИН РАЗМЕР", "УНИВЕРСАЛЬНЫЙ"],
        ...
        c, l, _, p, u, g, m = {
            ...
            bytes: ["Б", "B", "Кб", "Кбайт", "KiB", "KB", "Мбайт", "Мб", "MiB", "MB", "Mb", "Гбайт", "Гб", "GiB", "GB", "Gb", "Тбайт", "Тб", "TiB", "TB"],
